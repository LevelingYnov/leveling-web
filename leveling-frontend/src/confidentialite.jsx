  ...
  return (
    <section className="confidentialite">
      ...
      <p>
        ...
        utilisateurs du site (A remplir) sur la manière dont leurs données
        personnelles sont collectées, utilisées, et protégées, conformément au
      ...
      <ul>
        <li>
          ...
          d&apos;utilisateur, adresse e-mail, mot de passe.
        </li>
        <li>
          <strong>Données de connexion :</strong>nom d&apos;utilisateur, adresse
          e-mail, mot de passe.
        </li>
        <li>
          <strong>Données de paiement :</strong>factures.
        </li>
        <li>
          <strong>Données de navigation :</strong>Pages visitées, clics,
          préférences
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          L&apos;amélioration des services et de l&apos;expérience utilisateur.
        </li>
      ...
      <p>
        Elles peuvent être partagées avec des prestataires de services tiers
        dans le cadre de l&apos;exécution de nos services (paiements,
        hébergement du site) ou pour répondre à des obligations légales.
      </p>
      <h2>5. Sécurité des données</h2>
      <p>
        Nous mettons en œuvre toutes les mesures de sécurité nécessaires pour
        protéger vos données personnelles contre tout accès non autorisé,
        altération, divulgation ou destruction. Toutefois, aucune méthode de
      ...
      <ul>
        ...
        <li>
          ...
          l&apos;utilisation de vos données personnelles à des fins de marketing
          direct.
        </li>
        <li>
      ...
      <p>
        ...
        suivante : <a href="#">(A remplir)</a>.
      </p>
      <h2>7. Cookies</h2>
      <p>
        Le site (A remplir) utilise des cookies pour améliorer l&apos;expérience
        utilisateur. Les cookies sont des petits fichiers textes stockés sur
        votre appareil lorsque vous visitez notre site. Ils nous aident à
        comprendre comment vous interagissez avec notre site et à personnaliser
        votre expérience. Vous pouvez configurer votre navigateur pour refuser
        les cookies ou pour vous alerter lorsque des cookies sont utilisés.
      </p>
      <h2>8. Contact</h2>
      <p>
