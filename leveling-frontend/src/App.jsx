            ...
            <div>
                ...
                <div className="download-application-container feature-card">
                    ...
                    <p className={"download-descriptions"}>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sodales maximus risus, quis
                        congue libero convallis vel. Sed ut lorem quis nisl finibus pharetra. Donec dictum lorem vel
                        odio efficitur blandit. Maecenas hendrerit ante non lobortis condimentum. Vivamus sodales
                        tellus id tincidunt lacinia. Quisque nec tellus nec massa ultrices consectetur id vel ante.
                        Duis nec nisi mollis, efficitur lorem pharetra, sagittis sapien. Integer eu tellus eget
                        purus ullamcorper efficitur. Sed ac lacus placerat, cursus libero ac, elementum nunc. Proin
                        at lectus id metus suscipit dictum sit amet a urna. Duis bibendum mauris eu turpis viverra
                        egestas. Pellentesque semper arcu eu rhoncus mattis. Nunc sit amet urna augue. Nulla nunc
                        quam, tempor id turpis eu, vehicula sodales ante. Maecenas ultricies ullamcorper luctus.
                        Suspendisse sit amet semper justo.
                    </p>
                    <div className={"ios-android-container"}>
                        <div className={"ios"}>
                            <img className={"picture"} id={"ios-logo"}
                                 src={iosLogo} alt="Play-store-logo" width={logoWidth} height={logoHeight}/>{/*
                            */}App Store
                        </div>
                        <div className={"android"}>
                            <img className={"picture"} id={"android-logo"}
                                 src={androidLogo} alt="Play-store-logo" width={logoWidth} height={logoHeight}/>{/*
                                 */}Google Play
                        </div>
                    ...
                    <div className={"download-container"}>
                        <div className={"download"}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="256" height="38" viewBox="0 0 256 38"
                                ...
                                <defs>
                                    <radialGradient id="paint0_angular_179_4" cx="0" cy="0" r="1"
